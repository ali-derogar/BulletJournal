...
interface TaskCardProps {
  ...
  onCopyToNextDayChange: (task: Task, isCopied: boolean) => void;
  isExpanded?: boolean;
  onToggleExpand?: () => void;
}
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <motion.button
            ...
            onClick={(e) => {
              e.stopPropagation();
              onCopyToNextDayChange(task, !task.isCopiedToNextDay);
            }}
            className={`p-2 rounded-lg transition-all ${
              task.isCopiedToNextDay
